...
UBUNTU_TRANSLATION_DOMAIN="gigs.fulvio"
...
aptest.commands = bash $$PWD/Gigs/tests/autopilot/run
aptest.depends  = sub-Gigs

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Gigs/tests/unit 
unittest.depends  = sub-Gigs
